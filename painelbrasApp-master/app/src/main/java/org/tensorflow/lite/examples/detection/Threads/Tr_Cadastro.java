...
import org.tensorflow.lite.examples.detection.CadastroActivity;
...
public Object paramet[]=null;
    ...
    CadastroActivity pr=null;
    BancoT b=null;
    public byte bgeral[]=null;
    public Tr_Cadastro(CadastroActivity pr) {
        this.pr = pr;
        this.b=pr.b;
try {
    ...
    public Tr_Cadastro(CadastroActivity pr, Object...parmet){
        this.pr=pr;
        this.b=pr.b;
        this.paramet=parmet;
try{
    ...
    public Tr_Cadastro(boolean dialogo, CadastroActivity pr, Object...parmet){
        this.pr=pr;
        this.b=pr.b;
        try{
        if(dialogo)
